...
import { resolvePathToTempDir, removeAllFiles } from '../../utils'
import { generateHtmlFile, createHtmlContent } from '../../js-mode/generate-html-file'
...
test('should properly create html for few libraries', async t => {
  const lib1 = 'https://unpkg.com/react@16/umd/react.development.js'
  const lib2 = 'https://cdn.jsdelivr.net/npm/react@16.8.6/umd/react.production.min.js'
